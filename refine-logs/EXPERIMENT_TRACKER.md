...
|--------|-----------|---------|------------------|-------|---------|----------|--------|-------|
| R001 | M0 | Clean sanity | SAM2-tiny clean | 20 DAVIS clips | J, F, J&F, eligible count | MUST | DONE | 14/20 eligible (J&F>=0.60) |
...
| R004 | M1 | Core comparison | Suppression Hybrid | 20 clips | J&F drop, SSIM | MUST | DONE | mean dJF=0.862, median=0.934, NegScore=1.0, Collapse=1.0 |
| R005 | M1 | Core comparison | Decoy Hybrid v5 | 20 clips | J&F drop, SSIM | MUST | DONE | mean dJF=0.571, median=0.832, DecoyHit=1.0, CentShift=0.84 |
| R006 | M1 | Signature extraction | Suppression signatures | Results from R004 | NegScoreRate, CollapseRate | MUST | DONE | NegScore=1.00, Collapse=1.00 on all 14 eligible |
| R007 | M1 | Signature extraction | Decoy signatures | Results from R005 | PosScoreRate, DecoyHitRate, CentroidShift | MUST | DONE | PosScore=1.00, DecoyHit=1.00, CentShift=0.84 on all 14 eligible |
